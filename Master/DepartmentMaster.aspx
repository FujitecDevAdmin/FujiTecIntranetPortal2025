<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DepartmentMaster.aspx.cs" Inherits="FujiTecIntranetPortal.Master.DepartmentMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <div class="page-container scroll-y">
        <div>
            <h3 class="text-center" style="font-family: Verdana">Department Master</h3>
            <table class="normal_grid">
                <tr>
                    <th class="auto-style2"><strong>Department ID: <span class="hlt-txt">*</span></strong>
                    </th>
                    <td class="auto-style2">
                        <asp:TextBox ID="txtDepartmentID" CssClass="myInput" runat="server" Width="183px" TabIndex="1" Enabled="false"></asp:TextBox>
                    </td>
                    <th class="auto-style2"><strong>Department Name: <span class="hlt-txt">*</span></strong>
                    </th>
                    <td class="auto-style2">
