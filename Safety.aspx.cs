...
namespace FujiTecIntranetPortal
{
    public partial class Safety : System.Web.UI.Page
    {
        ...
        protected void btnSafetyPolicy_Click(object sender, EventArgs e)
        {

        }

        protected void btnORGChart_Click(object sender, EventArgs e)
        {

        }

        protected void btnSafetyInduction_Click(object sender, EventArgs e)
        {

        }

        protected void btnSafetyTrainingPhotos_Click(object sender, EventArgs e)
        {

        }

        protected void btnSafetyprocessvideos_Click(object sender, EventArgs e)
        {
        ...
        public void initialize()
        {
            try
            {
                ...
                DataRow dr = null;
                dr = dt.NewRow();
                string path = ConfigurationManager.AppSettings["FilePathSAFETY"].ToString();
        ...
        protected void View_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string embed = "<object data=\"{0}\" type=\"application/pdf\" width=\"80%\" height=\"500px\" controlsList=\"nodownload\" >";
                ...
                ltEmbed.Text = string.Format(embed, ResolveUrl("~/InductionFile/SAFETY/" + viewfilename + "#toolbar=0"));
            }
            catch (Exception ex)
            {
