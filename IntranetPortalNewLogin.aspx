...
<body>
    <form id="form1" runat="server">
        <body>
            ...
            <div class="marquee">
                <marquee behavior="scroll" direction="left" scrollamount="8" loop="-1">Dear Field Users,The Fujitec Mobile Apps (Site, Smart Technician, and Audit) are now available on the Google Play Store. Download Now!!!</marquee>
            </div>
                        ...
                        <div class="quote_slideshow-container">
                            <div class="quote_mySlides">
                                <div class="quote_card">
                                    <img class="quote_card-img" src="/assets/images/QT34.jpg" alt="Quote">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="column1">
                        <div class="quicklink-container">
                            ...
                            <a title="Click to Open Outlook" href="https://www.office.com/" target="_blank" class="quicklink-card">
                             ...
                             <a title="Click to Open FPT" href="http://fpt.fujitecindia.com:5000/login" target="_blank" class="quicklink-card">
                                <img id="quicklink9"  src="../assets/images/RoundedIcons/fpt.png" alt="FPT">
                            </a>
							...
							<a title="Click to Open DMS" href="https://dms.fujitecindia.com/#/login-form" target="_blank" class="quicklink-card">
								<img id="quicklink4" src="../assets/images/RoundedIcons/DMSNEW.png" alt="DMS">
							</a>
							
                            <a title="Click to Open HR Mantra" href="https://maxhr.myadrenalin.com/AdrenalinMAX/#/" target="_blank" class="quicklink-card">
                                <img id="quicklink5" src="../assets/images/RoundedIcons/AdrenalinMax.png" alt="AdrenalinMax">
                            </a>
     ...
     <!-- Popup HTML -->
              <!--<div id="popup" class="popup">
                ...
                <div class="popup-content">
                     <div class="close-button" onclick="hidePopup()"></div>
                    <img src="../assets/popup/NewProductAnnouncement.jpg" class="popup-image" alt="Popup Image" />
