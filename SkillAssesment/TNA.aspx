<%@ Page Title=""Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TNA.aspx.cs" Inherits="FujiTecIntranetPortal.SkillAssesment.TNA" %>
        ...
        <div>
            ...
            <table class="normal_grid">
                ...
                <tr>
                    ...
                    <td class="auto-style3">
                        <asp:TextBox ID="txtloc" CssClass="myInput" runat="server" Width="183px" TabIndex="3" Height="53px" Style="margin-left: 0" Enabled="false"></asp:TextBox>
                    </td>
            ...
            <table>
                <tr>
                    <td class="auto-style2" colspan="3" align="center">
                        <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="myInput" Visible="false"
                            TabIndex="12" ></asp:Button>
                          <asp:Button ID="btndownloadexcel" runat="server" Text="DownloadExcel" CssClass="myInput" 
                            TabIndex="13" OnClick="btndownloadexcel_Click"  ></asp:Button>
