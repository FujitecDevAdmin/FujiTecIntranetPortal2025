<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BusinessSupport.aspx.cs" Inherits="FujiTecIntranetPortal.BusinessSupport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    <div class="page-container scroll-y">
        <div id="divGridViewScroll" style="width: 100%; height: 600px; overflow: scroll" class="align-items-sm-center">
            <h2 class="text-center" style="font-family: Verdana">SalesPro Hub</h2>
            <div>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" HeaderStyle-BackColor="#04AFEF" HeaderStyle-ForeColor="White" HeaderStyle-CssClass="GridHeader">
                    <Columns>
                        <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                                <b>Axxx - INDEX </b>
                                <br />
                                <b>Bxxx - GENERAL COMMUNICATIONS </b>
                                <br />
                                <b>Cxxx - PROCESS RELATED</b><br />
                                <b>Dxxx - PRODUCT RELATED</b><br />
                                <b>Exxx - TECHNICAL INFORMATION</b><br />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="File name Prefix Identifications" HeaderStyle-Font-Size="Large" HeaderStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <b>Fxxx - FORMATS</b><br />
                                <b>Gxxx - ENQUIRY RELATED </b>
                                <br />
                                <b>Hxxx - FPT RELATED</b><br />
                                <b>Kxxx - LAYOUT RELATED</b><br />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                                <b>Lxxx - SCHEDULING RELATED</b><br />
                                <b>Jxxx - ORDER BOOKING RELATED</b><br />
                                <b>Mxxx - ESCALATOR & AUTOWALK</b><br />
                                <b>Zxxx - REVISION HISTORY</b><br />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
