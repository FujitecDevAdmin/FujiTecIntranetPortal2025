    ...
    public partial class HRInduction : System.Web.UI.Page
    {
        ...
        public void initialize()
        {
            try
            {
                ...
                DataRow dr = null;
                dr = dt.NewRow();
                string path = ConfigurationManager.AppSettings["HRFilePath"].ToString();
        ...
        protected void View_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string embed = "<object data=\"{0}\" type=\"application/pdf\" width=\"100%\" height=\"700px\" controlsList=\"nodownload\">";
                ...
                ltEmbed.Text = string.Format(embed, ResolveUrl("~/InductionFile/HR/" + viewfilename + "#toolbar=0"));
            }
            catch (Exception ex)
            {
