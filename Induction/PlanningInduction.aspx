<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PlanningInduction.aspx.cs" Inherits="FujiTecIntranetPortal.Induction.PlanningInduction" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <div class="page-container scroll-y">
        ...
        <div id="divGridViewScroll" style="width: 100%; height: 600px; overflow: scroll">
            <h2 class="text-center">Planning Induction</h2>
            <table>
                <tr>
                    <td colspan="3">
