<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProductionInduction.aspx.cs" Inherits="FujiTecIntranetPortal.Induction.ProductionInduction" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <div class="page-container scroll-y">
        ...
        <div id="divGridViewScroll" style="width: 100%; height: 600px; overflow: scroll">
            <h2 class="text-center">Production Induction</h2>
            <table>
                <tr>
                    <td colspan="3">
...
</asp:Content><asp:Content ID="Content3" ContentPlaceHolderID="FooterContent" runat="server">
    <div class="footer">
