    ...
    public partial class Engineering : System.Web.UI.Page
    {
        ...
        public void initialize()
        {
            try
            {
                ...
                DataRow dr = null;
                dr = dt.NewRow();
                string path = ConfigurationManager.AppSettings["FilePathENGINEERING"].ToString();
        ...
        protected void View_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ltEmbed.Text = string.Format(embed, ResolveUrl("~/InductionFile/ENGINEERING/" + viewfilename + "#toolbar=0"));
            }
            catch (Exception ex)
            {
