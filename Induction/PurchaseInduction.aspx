<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PurchaseInduction.aspx.cs" Inherits="FujiTecIntranetPortal.Induction.PurchaseInduction" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <div class="page-container scroll-y">
        ...
        <div id="divGridViewScroll" style="width: 100%; height: 600px; overflow: scroll">
            <h2 class="text-center">Purchase Induction</h2>
            <table>
                <tr>
                    <td colspan="3">
