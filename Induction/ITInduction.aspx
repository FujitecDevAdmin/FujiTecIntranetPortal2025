<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ITInduction.aspx.cs" Inherits="FujiTecIntranetPortal.Induction.ITInduction" %>
   ...
   <%-- <div align="right">
    ...
    <div class="page-container scroll-y">
        ...
        <div id="divGridViewScroll" style="width: 100%; height: 600px; overflow: scroll" class="align-items-sm-center">
            <h2 class="text-center" style="font-family:Verdana">IT Induction</h2>
            <table>
                <tr>
                    <td colspan="3">
