    ...
    public partial class Finance : System.Web.UI.Page
    {
        ...
        public void initialize()
        {
            try
            {
                ...
                DataRow dr = null;
                dr = dt.NewRow();
                string path = ConfigurationManager.AppSettings["FilePathFINANCE"].ToString();
        ...
        protected void View_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ltEmbed.Text = string.Format(embed, ResolveUrl("~/InductionFile/FINANCE/" + viewfilename + "#toolbar=0"));
            }
            catch (Exception ex)
            {
