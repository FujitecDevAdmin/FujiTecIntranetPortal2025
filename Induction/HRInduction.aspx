<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HRInduction.aspx.cs" Inherits="FujiTecIntranetPortal.Induction.HRInduction" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
      <div class="page-container scroll-y">
        ...
        <div id="divGridViewScroll" style="width: 100%; height: 100%; overflow: scroll" class="align-items-sm-center">
            <h2 class="text-center" style="font-family:Verdana">HR Induction</h2>
            <table>
                <tr>
                    <td colspan="3">
                ...
                <tr> <td>
                    <asp:Label ID="lblmsg" runat="server" Text="asdf" ForeColor ="White"></asp:Label>
                     </td>
                </tr>
            </table>
        </div>
