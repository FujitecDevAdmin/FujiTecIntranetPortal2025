<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuickLinks.aspx.cs" Inherits="ConfulenceLandingPage.UploadScreens.QuickLinks" %>
                ...
                [].forEach.call(files, function (file) {
                    ...
                    reader.onload = function (event) {
                        ...
                        img.onload = function () {
                            ...
                            if (Math.abs(aspectRatio - requiredRation) < 2) {
    ...
    <form id="form1" runat="server">
        <div class="container">
            <div id="uploadcontrols">
                <h2>Upload Awareness Images</h2>

                <asp:Label runat="server" AssociatedControlID="TextBoxApplicationName" Text="Application Name"></asp:Label>
                <asp:TextBox ID="TextBoxApplicationName" runat="server" placeholder="Enter Application Name"></asp:TextBox>
                <asp:RequiredFieldValidator CssClass="text-danger" ID="ApplicationNameValidator" runat="server"
                    ControlToValidate="TextBoxApplicationName" ErrorMessage="Please enter the Application Name" Text="*" ValidationGroup="UploadValidationGroup"></asp:RequiredFieldValidator>


                <asp:Label runat="server" AssociatedControlID="TextBoxApplicationURL" Text="Application URL"></asp:Label>
                <asp:TextBox ID="TextBoxApplicationURL" runat="server" placeholder="Enter Application URL"></asp:TextBox>
                <asp:RequiredFieldValidator CssClass="text-danger" ID="ApplicationURLValidator" runat="server"
                    ControlToValidate="TextBoxApplicationURL" ErrorMessage="Please enter the Application URL" Text="*" ValidationGroup="UploadValidationGroup"></asp:RequiredFieldValidator>
