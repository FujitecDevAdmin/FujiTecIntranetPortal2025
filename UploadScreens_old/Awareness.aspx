<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Awareness.aspx.cs" Inherits="ConfulenceLandingPage.UploadScreens.Awareness" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            <div id="uploadcontrols">
                ...
                <asp:Label runat="server" AssociatedControlID="TextBoxAwarenessCategory" Text="Awareness Category"></asp:Label>
                <asp:TextBox ID="TextBoxAwarenessCategory" runat="server" placeholder="Enter Awareness Category"></asp:TextBox>
                <asp:RequiredFieldValidator CssClass="text-danger" ID="AwarenessCategoryValidator" runat="server"
                    ControlToValidate="TextBoxAwarenessCategory" ErrorMessage="Please enter the awareness category" Text="*" ValidationGroup="UploadValidationGroup"></asp:RequiredFieldValidator>
